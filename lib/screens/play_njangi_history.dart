...
class PlayNjangiHistory extends StatefulWidget {
  const PlayNjangiHistory({super.key});

  @override
  PlayNjangiHistoryState createState() => PlayNjangiHistoryState();
}

class PlayNjangiHistoryState extends State<PlayNjangiHistory> {
  @override
  void initState() {
    super.initState();
  }
